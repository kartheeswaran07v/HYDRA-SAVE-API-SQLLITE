    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hydrasaveAPI.passmaster')),
            ],
        ),
        migrations.CreateModel(
            name='userMaster',
        ...
        migrations.AddField(
            ...
            name='trainId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hydrasaveAPI.trainmaster'),
        ),
        migrations.CreateModel(
